class NilInstance extends HTMLElement
{
    ...
    connectedCallback()
    {
        ...
        style.textContent = `
        :host{display:block;background:Field;white-space:pre-wrap;font-family:monospace;width:fit-content;min-width:3ch;margin:auto;border:inset 3px GrayText;}
        :host(:focus){outline:3px auto Highlight;outline auto 3px -webkit-focus-ring-color;}
        :host::part(placeholder){white-space:pre-wrap;}
        :host::part(input):focus{outline:none;}
        :host::part(placeholder){position:absolute;pointer-event:none;color:GrayText;content:host()[aria-placeholder];}
        `
...
function NilEditorInput(e)
{
    console.log(e)
    console.log(e.target.shadow)
}